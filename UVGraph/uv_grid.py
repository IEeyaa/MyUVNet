...
def get_uvgrid_by_face(face, num_u=10, num_v=10):
    ...
    return point_result_matrix, normal_result_matrix, visibility_result_matrix
...
def get_ugrid_by_edge(edge, num_u=10):
    ...
    # 将结果矩阵转换为 NumPy 数组
    point_result_matrix = np.array(point_result_matrix)
    tangent_result_matrix = np.array(tangent_result_matrix)

    return point_result_matrix, tangent_result_matrix
